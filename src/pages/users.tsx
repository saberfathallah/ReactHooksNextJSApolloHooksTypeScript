...
const Users: React.FC<{}> = () => {
  ...
  const [createUser] = useMutation<CreateUserResponse, InputMyFormValues>(CREATE_USER, { update: updateCacheAfterCreateUser });
  const [deleteUser] = useMutation<DeleteUserResponse, DeleteUserVars>(DELETE_USER, { update: updateCacheAfterDeleteUser });
